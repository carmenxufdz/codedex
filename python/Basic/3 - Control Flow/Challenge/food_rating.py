# Food Ratings
# In a five-star restaurant review system (⭐️⭐️⭐️⭐️⭐️), 
# the stars typically represent the different levels of 
# satisfaction.

# But what does each of the stars mean?

# Start by creating a rating variable and set it equal 
# to a decimal number.
